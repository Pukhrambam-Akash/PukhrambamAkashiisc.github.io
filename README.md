...
<head>
    ...
    <style>
        ...
        .link-style { color: #37bcf9; text-decoration: none; transition: color 0.3s; }
        .link-style:hover { color: #bb86fc; text-decoration: underline; }
        .section-container { padding-top: 5rem; padding-bottom: 5rem; }
        .section-title { font-size: 2.25rem; font-weight: 700; text-align: center; margin-bottom: 3rem; color: #ffffff; }
        .project-item { background-color: #1e1e1e; padding: 1.5rem; border-radius: 0.5rem 0.5rem 0 0; border-left: 4px solid #bb86fc; }
        .project-title { color: #ffffff; font-weight: 700; font-size: 1.25rem; }
        .project-date { color: #bb86fc; font-size: 0.9rem; font-weight: 500; }
        .slide-container { background-color: #1e1e1e; padding: 1rem; border-radius: 0 0 0.5rem 0.5rem; margin-top: -1px; }
        .cv-section { margin-bottom: 3rem; }
        .cv-section-title { font-size: 1.875rem; font-weight: 700; color: #ffffff; border-bottom: 2px solid #bb86fc; padding-bottom: 0.5rem; margin-bottom: 1.5rem; }
        .cv-entry-title { font-size: 1.25rem; font-weight: 700; color: #ffffff; }
        .cv-entry-subtitle { font-size: 1rem; color: #e0e0e0; margin-bottom: 0.5rem; }
        .cv-entry-date { font-size: 0.9rem; color: #bb86fc; }
        .ach-section { margin-bottom: 3rem; }
        .ach-section-title { font-size: 1.5rem; font-weight: 700; color: #ffffff; border-bottom: 1px solid #bb86fc; padding-bottom: 0.5rem; margin-bottom: 1.5rem; }
    </style>
</head>
                ...
                <div>
                    <div class="project-item">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="project-date">In Progress</span>
                        </div>
                         <div class="mt-4 flex justify-end space-x-4"><a href="#" class="link-style font-semibold">Paper</a><a href="#" class="link-style font-semibold">Code</a></div>
                    </div>
            ...
            <div class="max-w-4xl mx-auto bg-dark-card rounded-lg shadow-lg p-8">
                ...
                <section>
                    ...
                    <div class="space-y-4">
                        ...
                        <p>Synthesis of a polyaniline (printable nanoink) gas sensor for the detection of ammonia gas. <em class="text-gray-400">Journal of Materials Science, Dec 2020</em></p>
